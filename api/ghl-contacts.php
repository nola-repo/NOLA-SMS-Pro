...
// ── 2. Initialize GHL Client (Handles Token Lookup & Caching) ─────────────────
...
if ($method === 'GET') {
    ...
    do {
        ...
        // Convert full URL from meta to a relative path for the next request
        if ($nextPageUrl) {
    ...
    error_log("[ghl-contacts] Successfully fetched " . count($allContacts) . " contacts (Pages: $pageCount)");
