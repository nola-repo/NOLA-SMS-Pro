...
class MessageSyncService
{
    public static function recordMessageEvent($db, array $event): array
    {
        ...
        $messageData = array_filter([
            ...
            'provider_preference' => $event['provider_preference'] ?? null,
            'api_key_source' => $event['api_key_source'] ?? null,
            'sender_source' => $event['sender_source'] ?? null,
            'using_custom_key' => $event['using_custom_key'] ?? null,
